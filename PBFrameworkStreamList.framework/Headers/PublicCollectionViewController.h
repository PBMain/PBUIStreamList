...
@class StreamsModel;
@interface PublicCollectionViewController : UICollectionViewController <UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource, EventsCategoriesCellDelegate, PhotoAlbumViewControllerDelegate, MoreStreamsCellDelegate, MoreStreamsVCDelegate>
